...
if ($ShowPerms) { write-output $x.access |Sort-Object -property IdentityReference -unique |Format-Table -auto IdentityReference,IsInherited,AccessControlType,ActiveDirectoryRights}
$mod=$false
$OldSID=""
